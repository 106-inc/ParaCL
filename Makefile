...
BLD = PCL_BLD
FNB = flex+bison
DVR = DriverCC = g++ --std=c++2a

all: start_tmp2

compile:
  $(CC) $(BLD)/compiler.o $(BLD)/driver.o $(BLD)/inode.o $(BLD)/opnode.o $(BLD)/node.o
...
start_tmp2: bld_dir fb_bld bison flex driver ast
  $(CC) -o $(BLD)/paracl main.cc $(BLD)/*.o

start_tmp3: bld_dir fb_bld flex bison
